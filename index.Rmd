...
acf(diff(log(train.set$Close)), main = "Series: Log Differenced Closing Price")
...
Prior to determining how accurate the ARIMA model is with the addition of technical indicators, a based model will be built from the log differenced closing prices. This model will provide a point of comparison for the second ARIMA model. 
